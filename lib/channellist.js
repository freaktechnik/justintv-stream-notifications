 ...
 */
/**
 * Fired when all content of the ChannelList is removed.
 * @event module:channellist.ChannelList#clear
 */
 ...
 * @fires module:channellist.ChannelList#ready
 */
ChannelList.prototype.openDB = function(name) {
 ...
 * scratch.
 * @fires module:channellist.ChannelList#clear
 * @fires module:channellist.ChannelList#ready
 * @return {Promise}
...
ChannelList.prototype.clear = function() {
    ...
    if(this.db !== null) {
        ...
        // Reopen the DB after it's been cleared.
        return promise.then(() => this.openDB(NAME));
    }
};
