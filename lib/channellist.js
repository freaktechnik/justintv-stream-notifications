...
ChannelList.prototype.liveStatus = async(function*(type) {
    //TODO make live an index and then get all the channels that are live and count those.
    // that should be slightly faster than this O(n) operation on the array of all channels.
