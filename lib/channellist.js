...
UpdateQueue.prototype.getRequestByIndex = function(index) {
    ...
    if(this.queue[index].skip<this.queue[index].skipped&&!this.queue[index].priorized) {
        ...
        if(this.queue[index].persist) {
            ...
            if(this.queue[index].skipped>0) {
                this.queque[index].skipped = 0;
                if(this.queue[index].priorized) {
                    this.queque[index].priorized = false;
                }
            }
