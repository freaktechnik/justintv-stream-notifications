...
function ChannelList(options) {
    ...
    request.onupgradeneeded = function(e) {
        ...
        var store = channels.createObjectStore("channels", { autoIncrement: true });
        var keys = Object.keys(require("./channeluser").Channel.prototype);
...
ChannelList.prototype.getChannelsByType = function(type, callback) {
    if(!type)
        ...
        var transaction = channels.transaction([type], "readwrite"),
