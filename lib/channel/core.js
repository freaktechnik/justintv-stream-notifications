...
class User extends Item {
    /**
     * @param {module:channel/core~SerializedUser} properties - Serialized user.
     * @returns {module:channel/core.User} Deserialized user instance.
     */
     ...
     * @param {string} type - Type (provder) of the user.
...
class Channel extends Item {
    /**
     * @param {module:channel/core~SerializedChannel} properties - Serialized channel.
     * @returns {module:channel/core.Channel} Deserialized channel instance.
     */
    static deserialize(properties) {
        const props = omit(properties, ITEM_ARGS);
        props._uname = properties.uname;
     ...
     * @param {module:channel/live-state~SerializedLiveState} [state] - Live status of the channel.
     */
