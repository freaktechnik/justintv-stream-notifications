...
export default class ChannelList extends EventTarget {
     ...
     * @async
     * @returns {Array.<module:channel/core.Channel>} List of channels with the given type. May be empty.
     */
     ...
     * @async
     * @returns {Array.<module:channel/core.User>} List of users of the given type. May be empty.
     */
    getUsersByType(type) {
        return new Promise((resolve, reject) => {
            const transaction = this.db.transaction("users"),
     ...
     *                                                  favorites for.
     * @returns {Array.<module:channel/core.User>} List of users that follow the channel.
     */
     ...
     * @returns {Array.<module:channel/core.Channel>} List of channels that a user follows.
     */
