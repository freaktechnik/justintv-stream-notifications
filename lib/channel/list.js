...
export default class ChannelList extends EventTarget {
     ...
     * @async
     * @return {number} The ID of the channel if it exists.
     */
     ...
     * @async
     * @return {number} The ID of the user (if it exsits).
     */
    getUserId(name, type) {
        return new Promise((resolve, reject) => {
     ...
     * @return The user doesn't exist or no arguments passed.
     */
     ...
     * @return {module:channel/core.Channel} Added channel with the ID set.
     */
     ...
     * @fires module:channel/list.ChannelList#channelsadded
     * @async
     * @return {Array.<module:channel/core.Channel>} Added channels with their ID set.
     */
     ...
     * @return {module:channel/core.User} The newly added User with ID.
     */
    async addUser(user) {
     ...
     * @return {module:channel/core.Channel} The new version of the channel.
     */
     ...
     * @return {module:channel/core.User} The new version of the user stored
     *                                      in the ChannelList.
     */
    async setUser(user) {
        if(!("id" in user)) {
     ...
     * @return {module:channel/core.Channel} Resolves to the removed channel.
     */
     ...
     * @argument {string} [type] - Type of the channel if no ID was passed.
     * @async
     * @return {boolean} Resolves to a boolean indicating if the channel exists
     */
     ...
     * @argument {string} [type] - Type of the user if no ID was passed.
     * @async
     * @return {boolean} Resolves to a boolean indicating if the user exists.
     */
    userExists(id, type) {
     ...
     * @return {boolean} Resolves to a boolean indicating, if there are any live
     *                   channels.
     */
     ...
     * @async
     * @return {Array.<module:channel/core.Channel>}
     */
     ...
     * @fires module:channel/list.ChannelList#ready
     * @async
     * @return {boolean} If true the DB was deleted.
     */
    clear() {
