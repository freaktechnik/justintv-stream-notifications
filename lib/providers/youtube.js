...
const YouTube = newClass({
    ...
    getUserFavorites: async(function*(username) {
        ...
        if(data.json && data.json.items && data.json.items.length) {
            ...
            if(subscriptions.length) {
                ...
                let channels = subscriptions.map(function(sub) {
                    var ret = new Channel();
    ...
    updateRequest: function(channels, callback) {
        ...
        this._qs.queueUpdateRequest(urls, headers, this._qs.HIGH_PRIORITY, requeue, function(data, url) {
