...
/**
 * @event GenericProvider#updateduser
 * @type {channeluser.User}
 */
/**
 * @event GenericProvider#newchannels
 * @type {Array.<channeluser.Channel>}
 */
/**
 * @event GenericProvider#updatedchannels
 * @type {Array.<channeluser.Channel>|channeluser.Channel}
 */
...
const GenericProvider = newClass(
    /** @lends GenericProvider.prototype */
    {
         ...
         * @extends external:sdk/event/target.EventTargets
         ...
         * @fires GenericProvider#updateduser
         * @fires GenericProvider#newchannels
         * @abstract
         */
         ...
         * @fires GenericProvider#updatedchannels
         * @abstract
         */
