...
const Ustream = {
    ...
    getChannelDetails: function(channelname, callback) {
        qs.queueRequest("http://ustream.tv/"+channelname, headers, requeue).then(function(data) {
            if(data.status == 200) {
    ...
    updateChannel: function(channelname, callback) {
        ...
        qs.queueRequest(baseURL+'channels/'+channelname, headers, requeue).then(function(data) {
    ...
    updateChannels: function(channels, callback) {
        ...
        channels.forEach(function(channel) {
            Ustream.updateChannel(channel.login, callback);
        }, this);
    }
};
