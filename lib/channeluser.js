...
const Item = newClass(
/** @lends modules:channeluser~Item.prototype */
{
    /**
     * A generic thing.
     * @constructs
     ...
     * @return {Object} A serialized version of this item
     */
    serialize() {
        let obj = {
            uname: this.uname,
...
const User = newClass(
/** @lends module:channeluser.User.prototype */
{
    implements: [Item],
    /**
     * A generic user
     * @constructs
     * @argument {number} [id]
     * @extends module:channeluser~Item
     */
    initialize(id) {
        Item.prototype.initialize.call(this, id);
        this.favorites = [];
    },
    // properties
    /**
...
/** @lends module:channeluser.Channel.prototype */
{
    implements: [Item],
    /**
