...
//TODO Johnny, la gente esta mui loca, WTFFFFFFFFFFFFFFFFFFFFFFFFFFFFffffffffff
        ...
        return this.url.some(function(vUrl) {
            if(urlA.host) {
                ...
                var urlB = new URL(vUrl),
                    matches = [urlB.host.match(/(?:[a-z0-9]+\.)?([a-z0-9]+\.[a-z0-9]+)$/gi), urlA.host.match(/(?:[a-z0-9]+\.)?([a-z0-9]+\.[a-z0-9]+)$/gi)];
