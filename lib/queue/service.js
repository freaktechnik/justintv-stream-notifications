...
class QueueService {
    constructor() {
        ...
        this.HIGH_PRIORITY = "high";
        this.LOW_PRIORITY = "low";
    }
    ...
    queueRequest(url, headers = {}, requeue = defaultRequeue, attempt = 0) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(attempt === 0 && !NetUtil.ioService.offline)
    ...
    unqueueUpdateRequest(priority) {
        if(!priority) {
            this.unqueueUpdateRequest(this.HIGH_PRIORITY);
            this.unqueueUpdateRequest(this.LOW_PRIORITY);
        }
        else {
    ...
    queueUpdateRequest(urls, priority, callback, headers = {}, requeue = defaultRequeue) {
        ...
        const skips = priority == this.LOW_PRIORITY ? 4 : 0;
