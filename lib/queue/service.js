 ...
 * @argument {module:queueservice~QueueServiceListener} listeners
 */
exports.addQueueListeners = function({ containsPriorized, priorizedLoaded, paused, resumed }) {
 ...
 */
exports.removeQueueListeners = function({ containsPriorized, priorizedLoaded, paused, resumed }) {
    if(containsPriorized)
 ...
 */
let completeCallback = (requeue, callback, url, data) => {
    if(!requeue(data))
        callback(data, url);
};
