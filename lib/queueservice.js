 ...
 * provider, all in the same {@link module:queue.UpdateQueue}. The queue is
 * paused automatically when Firefox reports to be offline.
 * @author Martin Giger
 * @license MPL-2.0
 * @module queueservice
 ...
 * @argument {module:queueservice~QueueOptions} options
 */
...
/**
 * Temporarily pause the internal queue.
 */
exports.pause = function() {
    console.log("[QS]> paused");
 ...
 * @argument {function} [containsPriorized] - Callback for the
 * {@link module:queue.UpdateQueue#queuepriorized} event of the internal queue.
 * @argument {function} [priorizedLoaded] - Callback for the
 * {@link module:queue.UpdateQueue#allpriorizedloaded} event of the internal
 * queue.
 */
 ...
 * @argument {function} [containsPriorized] - Callback for the
 * {@link module:queue.UpdateQueue#queuepriorized} event to remove.
 * @argument {function} [priorizedLoaded] - Callback for the
 * {@link module:queue.UpdateQueue#allpriorizedloaded} event to remove.
 */
...
QueueService.prototype.unqueueUpdateRequest = function(priority) {
    if(!priority) {
        ...
        console.info("QueueService.unqueueUpdateRequest(",priority,")");
