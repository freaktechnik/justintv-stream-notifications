...
eyports.authURL =  "http://justin.tv";
    ...
    return getRequestObject(channel,function(achannel,aignoreNull,acallback) {
        var liveStatusRequest = Request({
            ...
            onComplete: function (response) {
                ...
                json = l? json[0]:channel;
                acallback(s,l,exports.getBasicUniChannelInfo(json),type,aignoreNull);
            }
        });
    ...
    return getRequestObject(source,function(asource,aignoreNull,acallback) {
        var favoritesRequest = Request({
            ...
            onComplete: function(response) {
                ...
                acallback(exports.checkResponse(response),extractChannelsFromList(asource,response.json),source,aignoreNull);
            }
        });
