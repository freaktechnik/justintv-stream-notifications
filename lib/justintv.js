...
function checkResponse(response) {
    ...
    if(response!=null) {
        ...
        if(response.status==200) {
            ...
            var r = (json.hasOwnProperty("rate_limited")&&(!json.message.match(/^199\.9\.2(4[89]?|5[1-5]?)?\.[0-2][1-5]?[1-9]?/)||!json.rate_limited))||!config.getPreference('justintv.ignoreRatelimit');
