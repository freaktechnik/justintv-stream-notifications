...
exports.main = function() {
    ...
    if(self.loadReason=='install'||self.loadReason=='enable') { // remove upgrade for next release
        this.init();
    }
...
exports.getUserFavorites = function(source,ignoreNull) {
    var favoritesRequest = Request({
        url: 'http://api.justin.tv/api/user/favorites/'+source.name+'.json?limit=100&offset='+source.page*100,
