...
function setConfig() {
    ...
    config.setPreference('justintv.ignoreRatelimit',true);
...
exports.queue = function(type,channel,ignoreNull,completeFunction,callback,persist,priorize) {
    var id = queue.addRequest(require("./"+type).getRequestObject(channel,completeFunction,ignoreNull,callback),persist,priorize);
