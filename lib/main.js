...
exports.attachChannelList = function() {
    ...
    data.on('channeldeleted',function(channelObj) {
        ...
        if(channelObj.status!=Channel.QUEUED) {
            ...
            exports.queue.removeRequest(channelObj);
        }
        else {
            exports.queue.removeRequest(require("./"+channelObj.type).getRequestObject(channelObj.getFirstSourceObject(),require("./"+channelObj.type).getChannelDetails,false,completeChannel));
        }
    });
