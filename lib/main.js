...
function requeueMultiChannelRequest(channelObj) {
    exports.unqueue(providers[channelObj.type].requestID);
    providers[channelObj.type].requestID = exports.queue(providers[channelObj.type].getStatusRequest(getChannelList(channelObj.type),true,exports.checkStatus),true,false,2);
}
