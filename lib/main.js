...
function requeueMultiChannelRequest(channelObj) {
    ...
    if(list!="")
        providers[channelObj.type].setRequestID(exports.queue(providers[channelObj.type].getStatusRequest(getChannelList(channelObj.type),true,exports.checkStatus),true,false,2));
}
