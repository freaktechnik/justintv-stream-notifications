...
controller.setTheme(parseInt(prefs.prefs.theme, 10));
...
prefs.on("theme", () => {
    const theme = parseInt(prefs.prefs.theme, 10);
    view.setTheme(theme);
