...
exports.setPanelAccess = function(type) {
    ...
    if(type==0) {
        ...
        panelWidget = require("sdk/widget").Widget({
          ...
          tooltip: live?_("live_panel_label"):_("live_panel_label_offline"),
          id: "live-channels",
        ...
        panelButton = require("toolbarbutton").ToolbarButton({
            ...
            label: _("live_widget_label"),
            tooltiptext: live?_("live_panel_label"):_("live_panel_label_offline"),
            toolbarID: "nav-bar",
...
exports.channelLiveActions = function(channel) {
    ...
    if(prefs.accessType == 0 && panelWidget.contentURL == self.data.url("panel_icon_empty.png")) {
        panelWidget.contentURL = self.data.url("panel_icon.png");
        panelWidget.tooltip = _("live_widget_label");
    }
    else if(prefs.accessType == 1 && panelButton.image == self.data.url("panel_icon_empty.png")) {
