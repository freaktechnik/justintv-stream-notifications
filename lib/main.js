    ...
    var rateRequest = Request({
        ...
        onComplete: function (response) {
            ...
            if(exports.checkResponse(response)) {
                ...
                else if(data.channels[channel] && (data.channels[channel].status == Channel.UPDATING||data.channels[channel].status==Channel.UPDATING))
                    data.channels[channel].status = Channel.FULL;
            }
            else if(exports.noFatalError(response)) {
