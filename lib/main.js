    ...
    if(prefs.usernameList!='') {
        ...
        for(var username of usernames) {
            ...
            if(data.users[username].sources.onlySourceSet(s))
                data.users[username].requestID = exports.queue(providers["justintv"].getUserFavorites(new Source(Source.TYPE_USERNAME,username,"justintv",{'page':0}),false,processUserFavorites),false,true);
        }
