...
exports.setChannels = function(source,channelNames,rich) {
    ...
    if(channelNames.length>0&&channelNames[0]!='') {
        ...
        for each(var channel in channelNames) {
            ...
            if(!rich)
				exports.checkRateLimit({'name':source.name,'type':source.type,'channel':channel},exports.getChannelDetails,false);
			else
...
exports.getUserFavorites = function(source,ignoreNull) {
    var favoritesRequest = Request({
        ...
        onComplete: function (response) {
            if(response!=null&&exports.exactArraySearch(data.users,source.name,false))
...
exports.getChannelDetails = function(source,ignoreNull) {
    var detailRequest = Request({
        ...
        onComplete: function (response) {
            if(respone!=null&&!response.json.error)  {
                if(exports.channelExists(source.channel)&&data.channels[source.channel].status=='queued') {
