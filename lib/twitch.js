...
exports.getStatusRequest = function(channel,ignoreNull,callback) {
    return {
        ...
        onComplete: function (response) {
            ...
            json = l? json.streams:[{'channel':{'name':channel,'stripped':true}}];
            console.log(channel+' is live: '+l);
            callback(s,l,exports.getBasicUniChannelInfo(json[0].channel),type,ignoreNull)
        }
    };
};
