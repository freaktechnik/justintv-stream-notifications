...
exports.authURL = "http://twitch.tv";
exports.requestID;
...
exports.getStatusRequest = function(channel,ignoreNull,callback) {
    return {
        ...
        onComplete: function (response) {
            ...
            callback(s,l,exports.extractChannelsFromList(json),type,ignoreNull);
        }
    };
};
...
exports.getUserFavorites = function(source,ignoreNull,callback) {
    return {
        ...
        onComplete: function(response) {
            ...
            callback(exports.checkResponse(response),extractChannelsFromList(response.json.follows),source,ignoreNull);
        }
    };
};
