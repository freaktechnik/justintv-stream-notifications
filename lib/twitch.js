...
exports.getUserFavorites = function(source,ignoreNull,callback) {
    return {
        ...
        onComplete: function(response) {
            ...
            callback(exports.checkResponse(response),response.json.follows,source,ignoreNull,extractChannelsFromList(source,response.json.follows));
        }
    };
};
