...
export default class GenericProvider extends EventTarget {
    ...
    /**
     * If channels generated by this provider have unique slugs.
     *
     * @type {boolean}
     * @protected
     * @readonly
    ...
    /**
     * Updates the login for items that don't have a login that's different from
     * the slug yet.
     *
     * @param {module:channel/core~Item} channel - Item to update the login of.
     */
    updateLogin(channel) {
